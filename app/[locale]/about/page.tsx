...
export default function About() {
  ...
  return (
    ...
    >
      ...
      >
        <svg
          className="relative block w-full h-full text-[#f9f8f4]"
      ...
      <div
        className="absolute -z-10 top-16 -left-10 w-72 h-72 bg-[#FF8FA3]/25 rounded-full blur-xl pointer-events-none will-change-transform transform-gpu"
        aria-hidden
      />
      <div
